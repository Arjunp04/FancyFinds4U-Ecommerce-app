  ...
  return (
    <div className="bg-white p-6 max-w-3xl">
      ...
      <form onSubmit={handleAddProduct} className="space-y-5">
        {/* Image Upload */}
        <div>
          <p className="mb-2 text-gray-600">Upload Product Images</p>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
          <div>
            <p className="mb-1 text-gray-600">Product Name</p>
            <input
          ...
          <div>
            <p className="mb-1 text-gray-600">Price (Rs)</p>
            <input
              className="w-full border px-3 py-2 rounded-lg focus:ring-1 focus:outline-none focus:border-blue-500"
              type="number"
              required
        ...
        <div className="grid grid-cols-2 gap-4">
          ...
          <div>
            <p className="mb-1 text-gray-600">SubCategory</p>
            <select
              className="w-full border px-3 py-2 rounded-lg focus:ring-1 focus:outline-none focus:border-blue-500"
        ...
        {/* Sizes */}
        <div>
          <p className="mb-2 text-gray-600">Sizes</p>
          <div className="flex gap-2">
        ...
        <div className="flex items-center justify-between">
          <p className="text-gray-600">Mark as Bestseller</p>
